...
<head>
    ...
    <div class="w-full max-w-5xl bg-white/90 backdrop-blur-lg rounded-2xl border border-gray-200 grid grid-cols-1 md:grid-cols-2 overflow-hidden animate-fadeIn">
        ...
        <img src="{{ asset('storage/images/gedung TI1.jpeg') }}"
            alt="Gedung Kampus"
            ...
            <div class="max-w-md w-full bg-white p-8 sm:p-10 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100">
                ...
                <div>
                 ...
                 <div class="rounded-lg bg-blue-50 p-4 text-sm text-blue-700 border border-blue-100">
                     ...
                     <a href="{{ route('verification.form') }}?email={{ session('email_exists') }}" class="font-medium underline hover:text-blue-800">
                         Kirim ulang kode.
                     </a>
                 </div>
                 @endif
                ...
                <form class="mt-8 space-y-5" method="POST" action="{{ route('register') }}">
                    ...
                    <div>
                        ...
                        <input id="email" name="email" type="email" required value="{{ old('email') }}"
                            class="block w-full rounded-lg @error('email') border-red-300 text-red-900 focus:border-red-500 focus:ring-red-500/20 @else border-gray-300 focus:border-blue-500 focus:ring-blue-500/20 @enderror py-2 px-4 text-gray-900 sm:text-sm transition outline-none border"
