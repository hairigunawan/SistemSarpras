<aside class="flex flex-col justify-between w-64 p-6 bg-white">
    <div>
        ...
        <nav>
            <ul>
                <li class="mb-2">
                    <a href="{{ Route('dashboard.index') }}" class="flex items-center p-3 text-sm rounded-lg gap-2 font-medium {{ request()->is('dashboard*') ? 'pl-7 bg-blue-100 text-blue-800' : 'text-gray-600 hover:bg-gray-100' }}">
