<aside class="w-64 bg-white p-6 flex flex-col justify-between">
    <div>
        <div class="mb-10">
            <h1 class="text-2xl font-bold text-gray-800">SIMPERSITE.</h1>
        </div>
        <nav>
            <ul>
                <li class="mb-2">
                    <a href="{{ Route('admin.dashboard') }}" class="flex items-center p-3 gap-2 text-sm rounded-lg font-medium {{ request()->is('admin/dashboard*') ? 'pl-7 bg-green-100 text-green-700' : 'text-gray-600 hover:bg-gray-100' }}">
                     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M10 13H4a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-6a1 1 0 0 0-1-1m-1 6H5v-4h4ZM20 3h-6a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1m-1 6h-4V5h4Zm1 7h-2v-2a1 1 0 0 0-2 0v2h-2a1 1 0 0 0 0 2h2v2a1 1 0 0 0 2 0v-2h2a1 1 0 0 0 0-2M10 3H4a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1M9 9H5V5h4Z"/></svg>
                        Dashboard
                    </a>
                </li>
                <li class="mb-2">
                    <a href="{{ Route('peminjaman.index') }}" class="flex items-center p-3 text-sm rounded-lg gap-2 font-medium {{ request()->is('peminjaman*') ? 'pl-7 bg-green-100 text-green-700' : 'text-gray-600 hover:bg-gray-100' }}">
                 ...
                 <li class="mb-2">
                    <a href="{{ Route('sarpras.index') }}" class="flex items-center text-sm p-3 gap-2 rounded-lg font-medium {{ request()->is('sarpras*') ? 'pl-7 bg-green-100 text-green-700' : 'text-gray-600 hover:bg-gray-100' }}">
                ...
                <li class="mb-2">
                    <a href="#" class="flex items-center gap-2 p-3 rounded-lg font-medium text-sm {{ request()->is('laporan*') ? 'pl-7 bg-green-100 text-green-700' : 'text-gray-600 hover:bg-gray-100' }}">
                ...
                <li class="mb-2">
                    <a href="#" class="flex items-center p-3 gap-2 rounded-lg font-medium text-sm {{ request()->is('jadwal*') ? 'pl-7 bg-green-100 text-green-700' : 'text-gray-600 hover:bg-gray-100' }}">
    ...
    <div class="text-xs text-gray-400">
        <p>© 2025 SIMPERSITE</p>
        <a href="#" class="hover:underline">Kebijakan Privasi</a> | <a href="#" class="hover:underline">Syarat & Ketentuan</a>
    </div>
</aside>
