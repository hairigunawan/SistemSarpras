            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 fade-in">
                    <div class="aspect-video bg-gray-100 rounded-lg overflow-hidden">
                        @if($p->gambar) <img src="{{ Storage::url($p->gambar) }}" alt="{{ $p->nama_proyektor }}" class="aspect-video w-full rounded-xl object-cover shadow-md"> @else <div class="flex aspect-video w-full items-center justify-center rounded-xl bg-gray-100"> <span class="text-gray-400">Tidak ada gambar</span> </div> @endif
                    </div>
