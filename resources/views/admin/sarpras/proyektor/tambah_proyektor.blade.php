    ...
    <form action="{{ route('sarpras.proyektor.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="nama_proyektor" id="nama_proyektor" value="{{ old('nama_proyektor') }}" required class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
            ...
            <div>
                ...
                <input type="text" name="merk" id="merk" value="{{ old('merk') }}" required class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
            ...
            <div>
                ...
                <input type="text" name="kode_proyektor" id="kode_proyektor" value="{{ old('kode_proyektor') }}" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
