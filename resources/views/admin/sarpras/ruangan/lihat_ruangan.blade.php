            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 fade-in">
                    <div class="aspect-video bg-gray-100 rounded-lg overflow-hidden">
                        L73: @if($r->gambar) <img src="{{ Storage::url($r->gambar) }}" alt="{{ $r->nama_ruangan }}" class="aspect-video w-full rounded-xl object-cover shadow-md"> @else <div class="flex aspect-video w-full items-center justify-center rounded-xl bg-gray-100"> <span class="text-gray-400">Tidak ada gambar</span> </div> @endif
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex justify-between pt-4 border-t border-blue-100">
                            <a href="{{ route('sarpras.ruangan.edit_ruangan', $r->id_ruangan) }}"
                               class="flex px-8 py-1.5 text-sm font-medium text-[#1180ab] bg-blue-100 border border-blue-300 rounded-sm hover:bg-blue-50 transition-colors">
                               <svg class="-ml-1 mr-2 h-5 w-5 text-[#1180ab]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
