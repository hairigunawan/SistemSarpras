                    ...
                    <div class="relative">
                        <button @click="open = !open" class="px-3 py-1.5 bg-blue-100 hover:bg-blue-200 rounded-sm text-xs font-medium flex items-center gap-2 transition-colors">
                            <span>
                                ...
                                @elseif($periode === 'semester') Semester
                                @else Pilih Periode
                                @endif
                            </span>
                            <span class="text-gray-600 transition-transform duration-200"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="bg-white p-6 border border-gray-200 rounded-xl shadow-sm">
            <div class="mb-6">
                ...
                <p class="text-sm text-gray-500">Berdasarkan periode: <span class="font-medium text-gray-700">{{ $periodeLabel ?? 'Semua Waktu' }}</span></p>
            </div>
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                        <div class="flex items-center gap-3 w-full">
                            ...
                            <div class="flex-grow">
                                <span class="text-gray-700 font-medium block">{{ $proyektor['nama'] }}</span>
                                <div class="w-full bg-green-200 rounded-full h-1.5 mt-1">
                                    <div class="bg-gray-500 h-1.5 rounded-full" style="width: {{ min(($proyektor['jumlah'] / 20) * 100, 100) }}%"></div>
                                </div>
                            </div>
                        </div>
