            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-center">{{ $p->proyektor->nama_proyektor ?? '-' }}</td>
    ...
    <div x-show="showHitung" x-transition>
        ...
        <div class="bg-white shadow-md rounded-lg border border-gray-200 mb-6 p-6">
            ...
            <table class="min-w-full border text-sm mb-4">
                ...
                <tbody>
                    <tr><td class="border px-4 py-2">Jenis Kegiatan</td><td class="border px-4 py-2 text-center">7</td><td class="border px-4 py-2 text-center">0.45</td></tr>
                    <tr><td class="border px-4 py-2">Jumlah Peserta</td><td class="border px-4 py-2 text-center">5</td><td class="border px-4 py-2 text-center">0.30</td></tr>
                    <tr><td class="border px-4 py-2">Durasi</td><td class="border px-4 py-2 text-center">3</td><td class="border px-4 py-2 text-center">0.15</td></tr>
                    <tr><td class="border px-4 py-2">Pengajuan</td><td class="border px-4 py-2 text-center">2</td><td class="border px-4 py-2 text-center">0.10</td></tr>
                </tbody>
            </table>
        ...
        <div class="bg-white shadow-md rounded-lg border border-gray-200 p-6">
            <h3 class="text-xl font-bold mb-4 text-green-800">Perhitungan SAW (Simple Additive Weighting)</h3>
