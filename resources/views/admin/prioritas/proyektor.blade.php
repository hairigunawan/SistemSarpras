                            ...
                            <table class="min-w-full">
                                ...
                                <tbody class="bg-white divide-y divide-gray-100">
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                                        ...
                                        @foreach ($row as $val)
                                            <td class="border-r border-gray-200 px-4 py-3 text-center text-sm font-mono @if($val == 1) bg-gray-100 font-semibold @endif text-gray-600">
                                                {{ number_format($val, 3) }}
                                            </td>
                                        @endforeach
                                    </tr>
                            ...
                            <table class="min-w-full">
                                ...
                                <tbody class="bg-white divide-y divide-gray-100">
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                                        ...
                                        <td class="border-r border-gray-200 px-4 py-3 font-medium bg-gray-50 text-sm text-gray-700">{{ $rowName }}</td>
                                        @foreach ($row as $val)
                                            <td class="border-r border-gray-200 px-4 py-3 text-center text-sm font-mono text-gray-600">{{ number_format($val, 3) }}</td>
                                        @endforeach
                            ...
                            <table class="min-w-full">
                                ...
                                <tbody class="bg-white divide-y divide-gray-100">
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                                        ...
                                        <td class="border-r border-gray-200 px-4 py-3 text-center font-mono text-sm font-semibold text-gray-700">{{ number_format($value['bobot'], 3) }}</td>
                    ...
                    <div class="bg-gray-50 p-6 rounded-lg border border-gray-200">
                        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center">
                            <div class="mb-4 sm:mb-0">
                                ...
                                <p class="text-2xl font-mono font-semibold text-gray-800">{{ number_format($cr, 3) }}</p>
                            </div>
