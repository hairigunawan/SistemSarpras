                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="ruangan" value="{{ old('ruangan', $j->ruangan) }}"
                                class="w-full pl-10 pr-4 py-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xs focus:ring-blue-500 focus:border-blue-500 block transition-all" required placeholder="Misal: LAB-01">
                        </div>
                    </div>
                </div>
