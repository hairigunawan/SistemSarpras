...
<div class="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-6 border-gray-200">
            <nav class="-mb-px border-b w-full sm:w-[440px] flex space-x-8 overflow-x-auto" aria-label="Tabs">
                @php
                    $tabs = [
                        'all' => 'Semua',
                        'Menunggu' => 'Menunggu',
