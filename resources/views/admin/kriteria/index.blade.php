...
<div x-data="{
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        ...
        <div class="flex gap-2">
            <a href="{{ route('admin.kriteria.perbandingan') }}"
               class="inline-flex items-center px-4 py-2 bg-green-600 text-xs uppercase tracking-widest hover:bg-green-700 text-white font-medium rounded-lg shadow-sm transition-colors duration-200">
