...
<div class="bg-gray-50 min-h-screen">
    ...
    <div class="relative w-full h-[500px] md:h-[600px] overflow-hidden">
        ...
        <div class="absolute inset-0 bg-cover bg-center bg-no-repeat transform scale-105"
             style="background-image: url('{{ asset('storage/images/gedung TI1.jpeg') }}');">
        </div>
        ...
        <div class="relative h-full flex flex-col justify-center items-center text-center text-white px-4 max-w-5xl mx-auto">
            <h1 class="text-4xl md:text-6xl font-extrabold mb-6 leading-tight tracking-tight">
                Sistem Informasi <br>
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#1180ab] to-cyan-300">Sarana dan Prasarana</span>
            </h1>
            ...
            <div class="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                <a href="#jadwal" class="px-8 py-2.5 text-sm rounded-full bg-[#1180ab] hover:bg-[#0d7198] text-white font-medium transition-all shadow-lg shadow-blue-600/30 flex items-center justify-center gap-2">
    ...
    <div class="container mx-auto px-4 md:px-6 py-12 -mt-12 relative z-10">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16">
            ...
            <div class="lg:col-span-7" id="jadwal">
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden h-full flex flex-col">
                    <!-- Header Kalender -->
                    <div class="bg-gradient-to-r from-[#1180ab] to-indigo-700 p-5 flex items-center justify-between">
                    ...
                    <div class="px-6 py-4 bg-gray-50 border-t border-gray-100">
                        <div class="flex flex-wrap items-center justify-center gap-6">
                            <div class="flex items-center gap-2">
                                <span class="flex h-3 w-3 rounded-full bg-[#1180ab] shadow-sm ring-2 ring-blue-200"></span>
            ...
            <div class="lg:col-span-5 flex flex-col gap-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden group transition-all duration-300">
                    ...
                    <div class="p-5">
                        <div class="flex items-start gap-3 text-gray-600 text-sm">
                            <svg class="w-5 h-5 text-[#1180ab] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 hover:border-blue-200 transition-all group">
                        ...
                        <h4 class="text-3xl font-bold text-gray-800">{{ $totalRuangan }}</h4>
                    </div>
                    ...
                    <div class="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 hover:border-purple-200 transition-all group">
                        ...
                        <h4 class="text-3xl font-bold text-gray-800">{{ $RuanganTerpakai }}</h4>
                    </div>
                </div>
                <div class="grid grid-cols-2 gap-4">
                    <!-- Stat 1 -->
                    <div class="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 hover:border-blue-200 transition-all group">
                        ...
                        <h4 class="text-3xl font-bold text-gray-800">{{ $totalProyektor }}</h4>
                    </div>
                    ...
                    <div class="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 hover:border-purple-200 transition-all group">
                        ...
                        <h4 class="text-3xl font-bold text-gray-800">{{ $ProyektorTerpakai }}</h4>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mb-12" id="informasi">
            <div class="text-center mb-10">
                ...
                <div class="h-1 w-20 bg-[#1180ab] mx-auto mt-3 rounded-full"></div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-8 rounded-2xl hover:shadow-sm transition-all duration-300 border border-gray-100 group">
                    <div class="w-14 h-14 bg-blue-50 rounded-xl flex items-center justify-center mb-6 group-hover:bg-[#0d7198] transition-colors duration-300">
                        <svg class="w-7 h-7 text-[#1180ab] group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
