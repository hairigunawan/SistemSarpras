    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
            ...
            <div class="px-6 pb-8 relative">
                ...
                @if(session('success'))
                    <div x-data="{ show: true }" x-show="show" class="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg flex justify-between items-center" x-init="setTimeout(() => show = false, 3000)">
                ...
                @if(session('error'))
                    <div x-data="{ show: true }" x-show="show" class="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg flex justify-between items-center" x-init="setTimeout(() => show = false, 3000)">
                        <div class="flex items-center">
