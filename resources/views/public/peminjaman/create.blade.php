            ...
            <div class="p-8 sm:p-10">
                ...
                <div class="text-center mb-10">
                    <h2 class="text-4xl font-extrabold text-gray-900 tracking-tight">
                        Formulir Peminjaman Sarpras
                    </h2>
                    <p class="mt-3 text-base text-gray-600">
                        Lengkapi detail berikut untuk mengajukan peminjaman fasilitas.
                    </p>
                </div>

                {{-- Form --}}
                <form action="{{ route('public.peminjaman.store') }}" method="POST" class="space-y-10">
                    @csrf
                    <input type="hidden" name="id_sarpras" value="{{ $selectedSarprasId }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="keterangan" id="keterangan" rows="4"
                                          class="mt-2 w-full rounded-xl border-gray-300 px-4 py-3 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                          placeholder="Contoh: Digunakan untuk kelas Pemrograman Web Lanjutan" required>{{ old('keterangan') }}</textarea>
                                @error('keterangan') 
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p> 
                                @enderror
                            </div>
