    ...
    const calendar = new Calendar(calendarEl, {
        ...
        eventClick(info) {
            ...
            if (typeof Swal !== 'undefined') {
                Swal.fire({
                    title: '<strong>' + info.event.extendedProps.jenis_kegiatan + '</strong>',
                    html: `
                        <div class="text-left space-y-3 p-2">
                            <div class="flex items-start gap-3 p-3 bg-blue-50 rounded-lg">
                                ...
                                <div>
                                    <span class="text-xs text-gray-500 font-semibold">Peminjam</span>
                                    <p class="text-sm font-bold text-gray-800">${info.event.extendedProps.peminjam_nama}</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-3 p-3 bg-blue-50 rounded-lg">
                                ...
                                <div>
                                    <span class="text-xs text-gray-500 font-semibold">Waktu</span>
                                    <p class="text-sm font-bold text-gray-800">${info.event.extendedProps.jam_mulai} - ${info.event.extendedProps.jam_selesai}</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-3 p-3 bg-blue-50 rounded-lg">
                                ...
                                <div>
                                    <span class="text-xs text-gray-500 font-semibold">Jumlah Peserta</span>
                                    <p class="text-sm font-bold text-gray-800">${info.event.extendedProps.jumlah_peserta} orang</p>
                                </div>
                            </div>
                        </div>
                    `,
