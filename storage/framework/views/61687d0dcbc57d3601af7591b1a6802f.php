<?php $__env->startSection('title', 'Detail proyektor'); ?>
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 fade-in hover-lift">
                    ...
                    <h2 class="text-xl font-semibold text-gray-900 mb-6">
                        <?php echo e($p->nama_proyektor ?? 'Nama proyektor'); ?>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-gray-900"><?php echo e($p->merk); ?></p>
                        </div>
                        ...
                        <div class="flex justify-between pt-4 border-t border-blue-100">
                            ...
                            <!-- Modal Konfirmasi -->
                            <div id="modal-<?php echo e($p->id_proyektor); ?>"
                                class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
                                <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-sm text-center">
                                    <h2 class="text-lg font-semibold text-gray-800 mb-2">Konfirmasi Hapus</h2>
                                    <p class="text-sm text-gray-600 mb-4">
                                        Apakah Anda yakin ingin menghapus proyektor <b><?php echo e($p->nama_proyektor); ?></b>?
                                    </p>

                                    <form action="<?php echo e(route('sarpras.proyektor.destroy', $p->id_proyektor)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('DELETE'); ?>

                                        <div class="flex justify-center gap-3 mt-4">
                                            <button type="button"
                                                    onclick="closeModal('<?php echo e($p->id_proyektor); ?>')"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SIMPERSITE\SistemSarpras\resources\views/admin/sarpras/proyektor/lihat_proyektor.blade.php ENDPATH**/ ?>