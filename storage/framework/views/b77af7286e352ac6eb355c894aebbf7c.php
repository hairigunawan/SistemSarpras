...
<div class="p-6 max-w-4xl mx-auto">
    <div class="bg-white shadow-sm rounded-2xl border border-gray-100 overflow-hidden">
        ...
        <form action="<?php echo e(route('admin.jadwal.store')); ?>" method="POST" class="p-8 space-y-8">
            <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <select name="ruangan"
                            ...
                            <?php $__currentLoopData = $ruangans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ruangan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($ruangan->nama_ruangan); ?>"><?php echo e($ruangan->nama_ruangan); ?></option>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SIMPERSITE\SistemSarpras\resources\views/admin/jadwal/create.blade.php ENDPATH**/ ?>