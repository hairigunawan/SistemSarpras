...
<div class="max-w-3xl mx-auto my-10 px-4">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="<?php echo e(route('admin.kriteria.index')); ?>" class="text-sm text-gray-600 hover:text-blue-600 flex items-center gap-1 transition-colors">
    ...
    <div class="bg-white border border-gray-200 shadow-lg rounded-2xl overflow-hidden">
        ...
        <form action="<?php echo e(route('admin.kriteria.update', $kriteria)); ?>" method="POST" class="p-8 space-y-8">
            <?php echo csrf_field(); ?>
                ...
                <div class="w-full md:w-1/2">
                    ...
                    <div class="relative">
                        <input type="text"
                            ...
                            class="w-full pl-4 pr-4 py-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block transition-all <?php $__errorArgs = ['nama_kriteria'];
...
unset($__errorArgs, $__bag); ?>
            ...
            <div x-data="{
                    open: false,
                    selected: '<?php echo e(old('tipe', $kriteria->tipe)); ?>',
                    getLabel() {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SIMPERSITE\SistemSarpras\resources\views/admin/kriteria/edit.blade.php ENDPATH**/ ?>