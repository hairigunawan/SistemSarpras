...
<div x-data="laporanPage()" class="min-h-screen p-6 bg-gray-50/50 space-y-8">
    ...
    <div class="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
        ...
        <div class="flex flex-wrap items-center gap-3">
            ...
            <!-- Export Buttons -->
            <a href="<?php echo e(route('laporan.pdf', ['periode' => $periode])); ?>" class="flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-white transition-all bg-gray-900 rounded hover:bg-gray-800 shadow-lg shadow-gray-200 hover:shadow-xl">
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></svg>
                PDF
            </a>

            <a href="<?php echo e(route('laporan.excel', ['periode' => $periode])); ?>" class="flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-green-700 transition-all bg-green-50 border border-green-200 rounded hover:bg-green-100 hover:border-green-300">
        ...
        <div class="relative p-6 overflow-hidden bg-white border border-gray-100 shadow-xs rounded group hover:shadow-sm transition-shadow">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-gray-900"><?php echo e($totalPeminjaman); ?></h3>
                </div>
            </div>
        </div>
        ...
        <div class="relative p-6 overflow-hidden bg-white border border-gray-100 shadow-xs rounded group hover:shadow-sm transition-shadow">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-gray-900"><?php echo e($PeminjamanHariIni); ?></h3>
                </div>
            </div>
        </div>
        ...
        <div class="relative p-6 overflow-hidden bg-white border border-gray-100 shadow-xs rounded group hover:shadow-sm transition-shadow">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-gray-900"><?php echo e(number_format($waktuRataRata, 1)); ?> <span class="text-sm font-normal text-gray-500">Jam</span></h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
        <div class="flex flex-col bg-white border border-gray-100 shadow-sm rounded">
            <div class="grid items-center justify-between px-6 py-5 border-b border-gray-100">
                ...
                <p class="text-xs text-gray-500 mt-0.5">Ranking berdasarkan frekuensi (<?php echo e($periodeLabel); ?>)</p>
            </div>
            <div class="p-6">
                <div class="space-y-5">
                    ...
                    <div class="flex items-center justify-between group">
                        <div class="flex items-center gap-4">
                            <span class="flex items-center justify-center w-8 h-8 text-xs font-bold <?php echo e($index < 3 ? 'text-blue-600 bg-blue-100' : 'text-gray-500 bg-gray-100'); ?> rounded-full">
                                <?php echo e($index + 1); ?>

                            </span>
                            <div>
                                <p class="text-sm font-semibold text-gray-900 group-hover:text-blue-600 transition-colors"><?php echo e($peminjam['nama']); ?></p>
                                <p class="text-xs text-gray-500"><?php echo e($peminjam['email']); ?></p>
                            </div>
                        </div>
                        <div class="flex items-center gap-2">
                            <span class="text-sm font-bold text-gray-900"><?php echo e($peminjam['jumlah']); ?></span>
        ...
        <div class="flex flex-col bg-white border border-gray-100 shadow-sm rounded">
            <div class="grid items-center justify-between px-6 py-5 border-b border-gray-100">
                ...
                <p class="text-xs text-gray-500 mt-0.5">Barang paling sering dipinjam (<?php echo e($periodeLabel); ?>)</p>
            </div>
            <div class="p-6">
                <div class="space-y-5">
                    ...
                    <div class="flex items-center justify-between group">
                        <div class="flex items-center gap-4">
                            <span class="flex items-center justify-center w-8 h-8 text-xs font-bold <?php echo e($index < 3 ? 'text-green-600 bg-green-100' : 'text-gray-500 bg-gray-100'); ?> rounded-full">
                                <?php echo e($index + 1); ?>

                            </span>
                            <div>
                                <p class="text-sm font-semibold text-gray-900 group-hover:text-green-600 transition-colors"><?php echo e($sarpras['nama']); ?></p>
                                <p class="text-xs text-gray-500">
                                    <?php if($sarpras['type'] === 'ruangan'): ?>
                                        <?php echo e($sarpras['lokasi'] ?? 'N/A'); ?>

                                    <?php elseif($sarpras['type'] === 'proyektor'): ?>
                                        <?php echo e($sarpras['merk'] ?? 'N/A'); ?>
                        ...
                        <div class="flex items-center gap-2">
                            <span class="text-xs font-medium text-gray-700"><?php echo e($sarpras['jumlah']); ?></span>
                            <span class="text-xs text-gray-500">x</span>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
