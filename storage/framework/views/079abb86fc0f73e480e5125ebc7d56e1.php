<nav x-data="{ mobileMenuOpen: false, profileOpen: false }" class="fixed top-0 left-0 w-full z-50 bg-white/80 backdrop-blur-md border-b border-gray-200 transition-all duration-300">
            ...
            <div class="flex-shrink-0 flex items-center gap-2">
                <a href="<?php echo e(route('public.beranda.index')); ?>" class="flex items-center gap-2.5">
                    <div class="flex gap-3">
                        <img
                            src="<?php echo e(asset('storage/images/TI.png')); ?>"
                            alt="Logo TI"
                            class="w-8 h-8 sm:w-10 sm:h-10 object-contain"
                        >

                        <img
                            src="<?php echo e(asset('storage/images/politala.png')); ?>"
                            alt="Logo Politala"
                            class="w-8 h-8 sm:w-10 sm:h-10 object-contain"
                        >
                    </div>
    ...
    <div x-show="mobileMenuOpen"
        ...
        <div class="px-4 pt-2 pb-3 space-y-1">
            ...
            <a href="<?php echo e(route('public.tentang_kami.index')); ?>"
                class="block px-3 py-2 rounded-md text-base font-medium <?php echo e(request()->routeIs('public.tentang_kami.*') ? 'bg-blue-50 text-[#179ACE]' : 'text-gray-700 hover:bg-gray-50 hover:text-[#179ACE]'); ?>">
                Tentang Kami
            </a>
        </div>
