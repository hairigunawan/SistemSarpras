<?php $__env->startSection('title', 'Akun - Buat Akun'); ?>
...
<div class="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-8">
                <form method="POST" action="<?php echo e(route('admin.akun.store.new')); ?>">
                    <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 text-red-900 placeholder-red-300 focus:ring-red-500 focus:border-red-500 <?php unset($message);
                            ...
                            <div class="relative">
                                <select name="role_id" id="role_id"
                                    ...
                                    <?php $__currentLoopData = $roles ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($r->id_role); ?>" <?php echo e(old('role_id') == $r->id_role ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SIMPERSITE\SistemSarpras\resources\views/admin/akun/tambah_akun.blade.php ENDPATH**/ ?>