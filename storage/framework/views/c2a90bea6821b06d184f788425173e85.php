    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden"
             x-data="peminjamanForm({
                ruanganId: '<?php echo e($defRuanganId); ?>',
                ruanganLabel: '<?php echo e($defRuanganLabel); ?>',
                proyektorId: '<?php echo e($defProyektorId); ?>',
                proyektorLabel: '<?php echo e($defProyektorLabel); ?>',
                lokasiId: '<?php echo e($defLokasiId); ?>',
                lokasiLabel: '<?php echo e($defLokasiLabel); ?>',
                ruanganProyektorId: '<?php echo e($defRuanganProyektorId); ?>',
                ruanganProyektorLabel: '<?php echo e($defRuanganProyektorLabel); ?>',
                kegiatan: '<?php echo e($defKegiatan); ?>'
             })">

            <form action="<?php echo e(route('public.peminjaman.store')); ?>" method="POST" class="divide-y divide-gray-100">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="relative group">
                            ...
                            <div class="flex items-center text-sm px-4 py-2 bg-white border border-gray-200 rounded text-gray-700 font-normal">
                                <?php echo e(Auth::check() ? (Auth::user()->name ?? Auth::user()->nama) : '-'); ?>

                            </div>
                            <input type="hidden" name="nama_peminjam" value="<?php echo e(Auth::check() ? (Auth::user()->name ?? Auth::user()->nama) : ''); ?>">
                        </div>

                        <div class="relative group">
                            <label class="block text-sm font-medium text-gray-500 mb-2">Email</label>
                            <div class="flex items-center text-sm px-4 py-2 bg-white border border-gray-200 rounded text-gray-700 font-normal">
                                <?php echo e(Auth::check() ? Auth::user()->email : '-'); ?>
                        ...
                        <div class="relative group">
                            ...
                            <div class="flex items-center text-sm px-4 py-2 bg-white border border-gray-200 rounded text-gray-700 font-normal">
                                <?php echo e(Auth::check() ? Auth::user()->nomor_telepon : '-'); ?>

                            </div>
                            <input type="hidden" name="nomor_telepon" value="<?php echo e(Auth::check() ? Auth::user()->nomor_telepon : ''); ?>">
                        </div>
                    </div>
                </div>
                                    ...
                                    <ul x-show="open" x-cloak
                                        ...
                                        <?php $__currentLoopData = $ruanganTersedia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ruangan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="text-gray-900 cursor-pointer select-none relative py-2 pl-3 pr-9 hover:bg-blue-50 transition-colors"
                                                @click="selectRuangan('<?php echo e($ruangan->id_ruangan); ?>', '<?php echo e($ruangan->nama_ruangan); ?>'); open = false">
                                                <span class="block truncate" :class="form.ruanganId == '<?php echo e($ruangan->id_ruangan); ?>' ? 'font-semibold text-blue-600' : 'font-normal'">
                                                    <?php echo e($ruangan->nama_ruangan); ?>

                                                </span>
                                                <span x-show="form.ruanganId == '<?php echo e($ruangan->id_ruangan); ?>'" class="absolute inset-y-0 right-0 flex items-center pr-4 text-blue-600">
                                ...
                                <div class="relative" x-data="{ open: false }">
                                    ...
                                    <ul x-show="open" x-cloak
                                        ...
                                        <?php $__currentLoopData = $proyektorTersedia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proyektor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="text-gray-900 cursor-pointer select-none relative py-2 pl-3 pr-9 hover:bg-blue-50 transition-colors"
                                                @click="selectProyektor('<?php echo e($proyektor->id_proyektor); ?>', '<?php echo e($proyektor->nama_proyektor); ?>'); open = false">
                                                <span class="block truncate" :class="form.proyektorId == '<?php echo e($proyektor->id_proyektor); ?>' ? 'font-semibold text-gray-600' : 'font-normal'">
                                    ...
                                    <ul x-show="open" x-cloak
                                        ...
                                        <?php $__currentLoopData = $lokasiList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $lokasi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="text-gray-900 cursor-pointer select-none relative py-2 pl-3 pr-9 hover:bg-blue-50"
                                                @click="form.lokasiId = '<?php echo e($id); ?>'; form.lokasiLabel = '<?php echo e($lokasi); ?>'; open = false">
                                                <span class="block truncate" :class="form.lokasiId == '<?php echo e($id); ?>' ? 'font-semibold text-gray-600' : 'font-normal'"><?php echo e($lokasi); ?></span>
                                            </li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div x-data="{ open: false }" class="relative">
                                    ...
                                    <ul x-show="open" x-cloak
                                        ...
                                        <?php $__currentLoopData = $allRuangan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ruangan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="text-gray-900 cursor-pointer select-none relative py-2 pl-3 pr-9 hover:bg-blue-50"
                                                @click="form.ruanganProyektorId = '<?php echo e($ruangan->id_ruangan); ?>'; form.ruanganProyektorLabel = '<?php echo e($ruangan->nama_ruangan); ?>'; open = false">
                                                <span class="block truncate" :class="form.ruanganProyektorId == '<?php echo e($ruangan->id_ruangan); ?>' ? 'font-semibold text-gray-600' : 'font-normal'"><?php echo e($ruangan->nama_ruangan); ?></span>
                                            </li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
                                </div>
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_pinjam" id="tanggal_pinjam" value="<?php echo e(old('tanggal_pinjam')); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <div class="relative rounded-xl shadow-sm">
                                <input type="number" name="jumlah_peserta" id="jumlah_peserta" value="<?php echo e(old('jumlah_peserta')); ?>"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="flex items-center space-x-4">
                                <div class="flex-1 relative">
                                    <input type="time" name="jam_mulai" value="<?php echo e(old('jam_mulai')); ?>" class="w-full border-gray-300 py-2 px-3 text-sm border rounded text-center">
                                ...
                                <div class="flex-1 relative">
                                    <input type="time" name="jam_selesai" value="<?php echo e(old('jam_selesai')); ?>" class="w-full border-gray-300 py-2 px-3 text-sm border rounded text-center">
                                    <span class="absolute left-3 top-3 text-gray-400 text-xs pointer-events-none">Selesai</span>
                                </div>
                            </div>
                            <div class="flex space-x-4 mt-1">
                                <div class="flex-1"><?php $__errorArgs = ['jam_mulai'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?></div>
                                <div class="flex-1"><?php $__errorArgs = ['jam_selesai'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-xs text-red-600"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></div>
                        ...
                        <div class="relative md:col-span-2" x-data="{ open: false }">
                            ...
                            <ul x-show="open" x-cloak
                                ...
                                <?php $__currentLoopData = ['Seminar Tugas Akhir', 'Seminar PKL', 'Kelas Materi', 'Kelas Praktikum', 'Rapat Organisasi', 'Lainnya']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="text-gray-900 cursor-pointer select-none relative py-2 pl-3 pr-9 hover:bg-blue-50 transition-colors"
                                        @click="form.kegiatan = '<?php echo e($item); ?>'; open = false">
                                        <span class="block truncate" :class="form.kegiatan == '<?php echo e($item); ?>' ? 'font-semibold text-blue-600' : 'font-normal'"><?php echo e($item); ?></span>

                                        <span x-show="form.kegiatan == '<?php echo e($item); ?>'" class="absolute inset-y-0 right-0 flex items-center pr-4 text-blue-600">
                                            <svg class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" /></svg>
                                        </span>
                                    </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
