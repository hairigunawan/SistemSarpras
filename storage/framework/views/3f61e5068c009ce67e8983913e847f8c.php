                                ...
                                <tbody class="bg-white divide-y divide-gray-100">
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                                        ...
                                        <?php $__currentLoopData = $row; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <td class="border-r border-gray-200 px-4 py-3 text-center text-sm font-mono <?php if($val == 1): ?> bg-gray-100 font-semibold <?php endif; ?> text-gray-600">
                            ...
                            <table class="min-w-full">
                                ...
                                <tbody class="bg-white divide-y divide-gray-100">
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                                        ...
                                        <td class="border-r border-gray-200 px-4 py-3 font-medium bg-gray-50 text-sm text-gray-700"><?php echo e($rowName); ?></td>
                                        <?php $__currentLoopData = $row; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <td class="border-r border-gray-200 px-4 py-3 text-center text-sm font-mono text-gray-600"><?php echo e(number_format($val, 3)); ?></td>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <td class="border-r border-gray-200 px-4 py-3 text-center font-semibold text-gray-700 bg-gray-50 font-mono text-sm">
                            ...
                            <table class="min-w-full">
                                ...
                                <tbody class="bg-white divide-y divide-gray-100">
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                                        ...
                                        <td class="border-r border-gray-200 px-4 py-3 text-center font-mono text-sm font-semibold text-gray-700"><?php echo e(number_format($value['bobot'], 3)); ?></td>
                    ...
                    <div class="bg-gray-50 p-6 rounded-lg border border-gray-200">
                        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center">
                            <div class="mb-4 sm:mb-0">
                                ...
                                <p class="text-2xl font-mono font-semibold text-gray-800"><?php echo e(number_format($cr, 3)); ?></p>
                            </div>
                        ...
                        <table class="min-w-full">
                            ...
                            <tbody class="bg-white divide-y divide-gray-100">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-150 <?php if($h['ranking'] == 1): ?> bg-yellow-50 border-l-2 border-yellow-400 <?php endif; ?>">
                                    ...
                                    <?php $__currentLoopData = $kriteria; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <td class="border-r border-gray-200 px-4 py-3 text-center text-sm font-mono text-gray-600">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SIMPERSITE\SistemSarpras\resources\views/admin/prioritas/proyektor.blade.php ENDPATH**/ ?>