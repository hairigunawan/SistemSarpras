...
<body class="bg-gray-100 text-gray-800 scroll-smooth">
    <div class="min-h-screen flex  flex-col overflow-hidden">
        <?php echo $__env->make('layouts.partials.NavbarPublic', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <footer class="bg-white border-t border-gray-200 py-8 mt-auto">
            <div class="container mx-auto px-4 text-center text-gray-500 text-sm">
                <p>&copy; <?php echo e(date('Y')); ?> SIMPERSITE - Jurusan Teknologi Informasi Politeknik Negeri Tanah Laut. All rights reserved.</p>
            </div>
        </footer>
    </div>
...
<?php /**PATH C:\xampp\htdocs\SistemSarpras\resources\views/layouts/guest.blade.php ENDPATH**/ ?>