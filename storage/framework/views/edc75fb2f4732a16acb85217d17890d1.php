    ...
    <div class="bg-white p-6 border border-gray-200 rounded-xl shadow-sm">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            ...
            <div class="flex gap-2 flex-wrap">
                <a href="<?php echo e(route('admin.dashboard', ['periode' => 'minggu'])); ?>"
                   class="px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 <?php echo e($periode === 'minggu' ? 'bg-blue-500 text-white shadow-lg transform scale-100' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'); ?>">
                    Minggu Ini
                </a>
                <a href="<?php echo e(route('admin.dashboard', ['periode' => 'bulan'])); ?>"
                   class="px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 <?php echo e($periode === 'bulan' ? 'bg-blue-500 text-white shadow-lg transform scale-100' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'); ?>">
                    Bulan Ini
                </a>
                <a href="<?php echo e(route('admin.dashboard', ['periode' => 'semester'])); ?>"
                   class="px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 <?php echo e($periode === 'semester' ? 'bg-blue-500 text-white shadow-lg transform scale-100' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'); ?>">
                    Semester Ini
                </a>
            </div>
        </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $topSarpras['ruangan'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $ruangan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="flex items-center justify-between p-3 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <span class="text-gray-700 font-medium"><?php echo e($ruangan['nama']); ?></span>
                                    <div class="w-full bg-blue-200 rounded-full h-2 mt-1">
                                        <div class="bg-blue-500 h-2 rounded-full" style="width: <?php echo e($ruangan['jumlah'] * 20); ?>%"></div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $topSarpras['proyektor'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $proyektor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="flex items-center justify-between p-3 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <span class="text-gray-700 font-medium"><?php echo e($proyektor['nama']); ?></span>
                                    <div class="w-full bg-blue-200 rounded-full h-2 mt-1">
                                        <div class="bg-blue-500 h-2 rounded-full" style="width: <?php echo e($proyektor['jumlah'] * 20); ?>%"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center mt-1">
                                    <div class="w-24 bg-gray-200 rounded-full h-2 mr-2">
                                        <div class="bg-blue-500 h-2 rounded-full" style="width: <?php echo e($peminjam['jumlah'] * 20); ?>%"></div>
                                    </div>
                                    <span class="text-xs text-gray-500"><?php echo e($peminjam['jumlah']); ?> peminjaman</span>
                                </div>
                            </div>
                        </div>
