                ...
                <div class="border-b pb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <p class="text-lg font-medium text-gray-900"><?php echo e($kriteria->nama_kriteria); ?></p>
                        </div>
                        <div>
                            ...
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium
                                ...
                                <i class="fas fa-<?php echo e($kriteria->tipe === 'benefit' ? 'arrow-up' : 'arrow-down'); ?> mr-1"></i>
                        ...
                        <div>
                            ...
                            <p class="text-lg font-medium text-gray-900"><?php echo e(number_format($kriteria->bobot, 4)); ?></p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-600 mb-1">Dibuat Pada</label>
                            <p class="text-gray-900"><?php echo e($kriteria->created_at->format('d F Y, H:i:s')); ?></p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-600 mb-1">Terakhir Diperbarui</label>
                            <p class="text-gray-900"><?php echo e($kriteria->updated_at->format('d F Y, H:i:s')); ?></p>
                        </div>
                    </div>
                </div>
