...
<div class="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-8 flex items-center justify-between">
            ...
            <a href="<?php echo e(route('admin.kriteria.index')); ?>" class="border border-gray-300 px-6 py-1.5 rounded-sm font-semibold text-gray-600 hover:text-gray-500 transition-colors">
                Kembali
            </a>
        </div>
            ...
            <div class="p-8">
                ...
                <form action="<?php echo e(route('admin.kriteria.store')); ?>" method="POST" class="space-y-6">
                    ...
                    <div class="group">
                        ...
                        <div class="relative">
                            <input type="text" id="nama_kriteria" name="nama_kriteria" value="<?php echo e(old('nama_kriteria')); ?>"
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div class="group">
                            ...
                            <select id="tipe" name="tipe" required
                                ...
                                <option value="benefit" <?php echo e(old('tipe') === 'benefit' ? 'selected' : ''); ?>>Benefit (+)</option>
                                <option value="cost" <?php echo e(old('tipe') === 'cost' ? 'selected' : ''); ?>>Cost (-)</option>
                            </select>
                        </div>
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                <input type="number" id="bobot" name="bobot" value="<?php echo e(old('bobot', '0.0000')); ?>" step="0.0001" min="0" max="1"
                                    class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-1 focus:bg-white transition-all duration-200"
