                ...
                <?php if(session('success')): ?>
                    <div x-data="{ show: true }" x-show="show" class="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg flex justify-between items-center">
                        <div class="flex items-center">
                            ...
                            <span class="text-green-700 text-sm font-medium"><?php echo e(session('success')); ?></span>
                        </div>
                ...
                <?php if(session('error')): ?>
                    <div x-data="{ show: true }" x-show="show" class="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg flex justify-between items-center">
                        <div class="flex items-center">
                            ...
                            <span class="text-red-700 text-sm font-medium"><?php echo e(session('error')); ?></span>
                        </div>
                        <button @click="show = false" class="text-red-500 hover:text-red-700">&times;</button>
                    </div>
                <?php endif; ?>

                <form method="POST" action="<?php echo e(route('public.profile.update')); ?>" class="space-y-6" x-data="{ submitting: false }" @submit="submitting = true">
                    <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" value="<?php echo e($user->nama); ?>" 
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="tel" 
                                   id="nomor_telepon" 
                                   name="nomor_telepon" 
                                   value="<?php echo e(old('nomor_telepon', $user->nomor_telepon)); ?>" 
                                   placeholder="08xxxxxxxxxx"
                                   class="w-full pl-10 py-2.5 border rounded-lg focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-colors <?php $__errorArgs = ['nomor_telepon'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 focus:ring-red-200 <?php else: ?> border-slate-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex flex-col-reverse sm:flex-row gap-3 pt-6 border-t border-slate-100 mt-6">
                        <a href="<?php echo e(route('public.profile.index')); ?>" 
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SIMPERSITE\SistemSarpras\resources\views/public/profile/edit.blade.php ENDPATH**/ ?>