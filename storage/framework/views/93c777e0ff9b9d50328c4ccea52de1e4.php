        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            ...
            <div class="px-6 py-5 border-b border-gray-200 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div class="flex space-x-3">
                    ...
                    <form action="<?php echo e(route('admin.akun.hapus_akun', $u->id_akun)); ?>" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus akun ini? Tindakan ini tidak dapat dibatalkan.');">
                        <?php echo csrf_field(); ?>
                ...
                <dl class="sm:divide-y sm:divide-gray-200">
                    ...
                    <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        ...
                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                            ...
                            <span class="text-gray-400 text-xs ml-1">(<?php echo e($u->updated_at ? $u->updated_at->format('d/m/Y H:i') : ''); ?>)</span>
                        </dd>
                    </div>
