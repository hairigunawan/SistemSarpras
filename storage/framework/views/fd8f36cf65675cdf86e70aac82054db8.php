<?php $__env->startSection('title', 'Riwayat Peminjaman Saya'); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div x-data="{ open: false }" class="relative inline-block text-left">
                    ...
                    <div x-show="open" @click.away="open = false"
                        ...
                        <div class="py-1" role="none">
                            <a href="<?php echo e(route('public.peminjaman.download_pdf')); ?>" class="text-slate-700 block px-4 py-2 text-sm hover:bg-slate-100" role="menuitem">Download PDF</a>
                            <a href="<?php echo e(route('public.peminjaman.export_excel')); ?>" class="text-slate-700 block px-4 py-2 text-sm hover:bg-slate-100" role="menuitem">Download Excel</a>
                        </div>
                    </div>
                </div>

                <!-- Tombol Print -->
                <a href="<?php echo e(route('public.peminjaman.print')); ?>" target="_blank"
        ...
        <div class="mb-4">
            <p class="text-xs text-slate-400">
                Menampilkan <?php echo e(count($p)); ?> data riwayat peminjaman Anda.
            </p>
        </div>
        <?php endif; ?>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-slate-100">
                    ...
                    <tbody class="divide-y divide-slate-100 bg-white">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $p; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-slate-50 transition-colors duration-200 group">
                                ...
                                <div class="flex items-center gap-3">
                                    <div>
                                        <div class="font-medium text-slate-900 text-sm">
                                            <?php echo e($item->ruangan->nama_ruangan ?? $item->proyektor->nama_proyektor ?? '-'); ?>

                                        </div>
                                        <div class="text-xs text-slate-500">
                                            <?php echo e($item->proyektor->merk ?? $item->ruangan->lokasi->nama_lokasi ?? '-'); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex flex-col gap-1">
                                    <div class="text-sm font-medium text-slate-700">
                                        <?php echo e(\Carbon\Carbon::parse($item->tanggal_pinjam)->translatedFormat('d F Y')); ?>

                                    </div>
                                    <div class="text-xs text-slate-500">
                                        <?php echo e(\Carbon\Carbon::parse($item->jam_mulai)->format('H:i')); ?> - <?php echo e(\Carbon\Carbon::parse($item->jam_selesai)->format('H:i')); ?> WIB
                                    </div>
                                </div>
                            </td>
                            ...
                            <!-- Keperluan -->
                            <td class="px-6 py-4">
                                <div class="text-sm text-slate-600 max-w-xs truncate" title="<?php echo e($item->jenis_kegiatan); ?>">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                ...
                                ?>
                                <span class="inline-flex items-center rounded-full px-2.5 py-1 text-xs font-medium <?php echo e($config['bg']); ?> <?php echo e($config['text']); ?> ring-1 ring-inset <?php echo e($config['ring']); ?>">
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SIMPERSITE\SistemSarpras\resources\views/public/peminjaman/riwayat_peminjaman.blade.php ENDPATH**/ ?>