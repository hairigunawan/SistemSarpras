...
<div class="bg-white">
    <div class="bg-white p-6 w-full max-w-full mx-auto">
        ...
        <form action="<?php echo e(route('sarpras.ruangan.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" text="lowercase first-letter:uppercase" name="nama_ruangan" id="nama_ruangan" placeholder="Lab C" value="<?php echo e(old('nama_ruangan')); ?>" required class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm" onblur="this.value = this.value.charAt(0).toUpperCase() + this.value.slice(1)">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="kode_ruangan" id="kode_ruangan" placeholder="C-01" value="<?php echo e(old('kode_ruangan')); ?>" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm" oninput="this.value = this.value.toUpperCase().trimStart()">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" name="kapasitas" id="kapasitas" placeholder="20" value="<?php echo e(old('kapasitas')); ?>" min="1" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm">
                ...
                <div>
                    ...
                    <select name="lokasi_id" id="lokasi_id" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm">
                        <option value="">Pilih Lokasi</option>
                            <?php $__currentLoopData = $l; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lokasi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($lokasi->id_lokasi); ?>"
                                <?php echo e(old('id_lokasi', $defaultLokasiId) == $lokasi->id_lokasi ? 'selected' : ''); ?>>
                    ...
                    <select name="id_status" id="id_status" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm">
                        ...
                        <?php $__currentLoopData = $s; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($status->id_status); ?>"
                                <?php echo e(old('id_status', $defaultStatusId) == $status->id_status ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SIMPERSITE\SistemSarpras\resources\views/admin/sarpras/ruangan/tambah_ruangan.blade.php ENDPATH**/ ?>