        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-lg font-semibold text-gray-900">Detail Ruangan</h1>
                        <p class="text-sm text-gray-500">Informasi lengkap ruangan</p>
                    </div>
                </div>
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 fade-in">
                    <div class="aspect-video bg-gray-100 rounded-lg overflow-hidden">
                        <?php if($r->gambar): ?> <img src="<?php echo e(asset('storage/' . $r->gambar)); ?>" alt="<?php echo e($r->nama_ruangan); ?>" class="aspect-video w-full rounded-xl object-cover shadow-md"> <?php else: ?> <div class="flex aspect-video w-full items-center justify-center rounded-xl bg-gray-100"> <span class="text-gray-400">Tidak ada gambar</span> </div> <?php endif; ?>
                    </div>
                    ...
                    <div class="mt-4 flex items-center justify-between">
                        <span class="inline-flex items-center rounded-full border px-3 py-1 text-xs font-medium <?php echo e($color); ?>">
                            <?php echo e($status); ?>
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 fade-in hover-lift">
                    ...
                    <h2 class="text-xl font-semibold text-gray-900 mb-6">
                        <?php echo e($r->nama_ruangan ?? 'Nama Ruangan'); ?>
                    ...
                    <div class="space-y-6">
                        ...
                        <!-- Status -->
                        <div>
                            <h3 class="text-sm font-medium text-gray-500 uppercase tracking-wider mb-2">Status Ruangan</h3>
                            <span class="inline-flex items-center rounded-full border px-3 py-1 text-xs font-medium <?php echo e($color); ?>">
                                <?php echo e($status); ?>
                        ...
                        <div>
                            ...
                            <p class="text-sm font-medium text-gray-900">
                                <?php echo e($r->lokasi->nama_lokasi); ?>
                        ...
                        <div>
                            ...
                            <p class="text-sm font-medium text-gray-900">
                                <?php echo e($r->kapasitas); ?> Orang
                            </p>
                        </div>

                        <div class="flex justify-between pt-4 border-t border-blue-100">
                            <a href="<?php echo e(route('sarpras.ruangan.edit_ruangan', $r->id_ruangan)); ?>"
                            ...
                            <button
                                type="button"
                                onclick="openModal('<?php echo e($r->id_ruangan); ?>')"
                            ...
                            <!-- Modal Konfirmasi -->
                            <div id="modal-<?php echo e($r->id_ruangan); ?>"
                                class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
                                <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-sm text-center">
                                    <h2 class="text-lg font-semibold text-gray-800 mb-2">Konfirmasi Hapus</h2>
                                    <p class="text-sm text-gray-600 mb-4">
                                        Apakah Anda yakin ingin menghapus ruangan <b><?php echo e($r->nama_ruangan); ?></b>?
                                    </p>

                                    <form action="<?php echo e(route('sarpras.ruangan.destroy', $r->id_ruangan)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('DELETE'); ?>

                                        <div class="flex justify-center gap-3 mt-4">
                                            <button type="button"
                                                    onclick="closeModal('<?php echo e($r->id_ruangan); ?>')"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SIMPERSITE\SistemSarpras\resources\views/admin/sarpras/ruangan/lihat_ruangan.blade.php ENDPATH**/ ?>