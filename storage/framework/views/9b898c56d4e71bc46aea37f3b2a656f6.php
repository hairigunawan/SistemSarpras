                        ...
                        <div class="relative">
                            <button @click="profileOpen = !profileOpen" @keydown.escape.window="profileOpen = false"
                                ...
                                <div class="text-right hidden lg:block mr-2">
                                    ...
                                    <p class="text-[10px] text-gray-500 uppercase tracking-wider mt-0.5"><?php echo e(Auth::user()->userRole->nama_role ?? 'User'); ?></p>
                                </div>
...
<?php /**PATH C:\xampp\htdocs\SistemSarpras\resources\views/layouts/partials/NavbarPublic.blade.php ENDPATH**/ ?>