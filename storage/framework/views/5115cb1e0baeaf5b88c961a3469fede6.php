        ...
        <div class="w-full max-w-md bg-white rounded-2xl border border-gray-200 p-8 shadow-sm">
            ...
            <form method="POST" action="<?php echo e(route('verification.verify')); ?>">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="email" value="<?php echo e(old('email') ?? $user->email ?? request('email')); ?>"
            ...
            <form id="resendForm" method="POST" action="<?php echo e(route('verification.resend')); ?>" style="display: none;">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="email" value="<?php echo e(old('email') ?? $email ?? request('email')); ?>">
            </form>
        </div>
    </div>
...
<?php /**PATH D:\SIMPERSITE\SistemSarpras\resources\views/auth/verify.blade.php ENDPATH**/ ?>