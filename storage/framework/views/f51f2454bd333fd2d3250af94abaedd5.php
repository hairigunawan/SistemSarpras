                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__empty_1 = true; $__currentLoopData = $kriterias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kriteria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 transition duration-150">
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm font-semibold text-gray-600"><?php echo e($kriteria->nama_kriteria); ?></div>
                                <div class="text-xs text-gray-500 mt-0.5">Dibuat: <?php echo e($kriteria->created_at->format('d M Y')); ?></div>
                            </td>

                            
                            <td class="px-6 py-4">
                                <span><?php echo e($kriteria->tipe); ?></span>
                            </td>
                            ...
                            <td class="px-2 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <button
                                        @click="showDeleteModal = true; deleteUrl = '<?php echo e(route('admin.kriteria.destroy', $kriteria)); ?>'; deleteName = '<?php echo e($kriteria->nama_kriteria); ?>'"
