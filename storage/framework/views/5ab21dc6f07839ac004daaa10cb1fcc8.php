...
<div class="bg-white rounded-lg p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex justify-between gap-4">
            <form method="GET" action="<?php echo e(route('admin.akun.index')); ?>" class="flex items-center space-x-2">
                <?php if(request('jenis')): ?>
                    <input type="hidden" name="nama" value="<?php echo e(request('nama')); ?>">
                <?php endif; ?>
                <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari Akun" class="w-full md:w-64 px-4 py-1.5 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-300">
            </form>
        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-50">
                    <td class="p-3 border text-sm"><?php echo e($a->nama); ?></td>
                    <td class="p-3 border text-sm"><?php echo e($a->email); ?></td>
                    <td class="p-3 border text-sm"><?php echo e($a->userRole->nama_role); ?></td>
                    <td class="p-3 border text-sm text-center">
                        <a href="<?php echo e(route('admin.akun.lihat_akun', $a->id_akun)); ?>"
